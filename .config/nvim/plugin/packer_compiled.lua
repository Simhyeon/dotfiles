...
_G.packer_plugins = {
  ...
  everforest = {
    loaded = true,
    path = "/home/simon/.local/share/nvim/site/pack/packer/start/everforest",
  ...
  ["nvim-treesitter-context"] = {
    loaded = true,
    path = "/home/simon/.local/share/nvim/site/pack/packer/start/nvim-treesitter-context",
  ...
  orgmode = {
    ...
    loaded = true,
    path = "/home/simon/.local/share/nvim/site/pack/packer/start/orgmode",
  ...
  ["rust.vim"] = {
    loaded = true,
    path = "/home/simon/.local/share/nvim/site/pack/packer/start/rust.vim",
  ...
  ["vim-cpp-enhanced-highlight"] = {
    loaded = true,
    path = "/home/simon/.local/share/nvim/site/pack/packer/start/vim-cpp-enhanced-highlight",
    url = "https://github.com/octol/vim-cpp-enhanced-highlight"
  },
  ["vista.vim"] = {
    loaded = true,
    path = "/home/simon/.local/share/nvim/site/pack/packer/start/vista.vim",
